...
from .models import CourseCategory, Basic_info, Slider, Course, Event, Project, CourseLevel, SingleVideo, Testimonial, \
    AboutUs, FAQ, UserMessage, Profile, TakenCourse
...
def course(request, category, course):
    ...
    if request.user.is_active:
        try:
            ...
            courses.save()
            '''
            taken_courses = TakenCourse(user=request.user,taken_course_title=single_course.course_title,
                                        taken_course_url=single_course.course_url,
                                        taken_course_image=single_course.thumbnail_image,
                                        taken_course_category=course_category.category_name,
                                        taken_category_url=course_category.category_url,
